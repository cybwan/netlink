...
static inline void genl_family_set_id(struct genl_family *family,
                                      unsigned int id) {
  family->gf_id = id;
...
static inline void genl_family_set_name(struct genl_family *family,
                                        const char *name) {
...
static inline void genl_family_set_version(struct genl_family *family,
                                           uint8_t version) {
...
static inline void genl_family_set_hdrsize(struct genl_family *family,
                                           uint32_t hdrsize) {
...
static inline void genl_family_set_maxattr(struct genl_family *family,
                                           uint32_t maxattr) {
