...
int unl_request_single(struct unl *unl, struct nl_msg *msg,
                       struct nl_msg **dest);
...
struct nl_msg *unl_nl80211_phy_msg(struct unl *unl, int phy, int cmd,
                                   bool dump);
struct nl_msg *unl_nl80211_vif_msg(struct unl *unl, int dev, int cmd,
                                   bool dump);

static inline void unl_loop_done(struct unl *unl) { unl->loop_done = true; }

static inline struct nlattr *unl_find_attr(struct unl *unl, struct nl_msg *msg,
                                           int attr) {
